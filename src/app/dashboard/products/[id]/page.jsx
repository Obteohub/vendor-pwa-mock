 ...
 * - Normalizes WooCommerce data for editing
 */
async function getProduct(productId) {
  ...
  const wcV3Url = process.env.NEXT_PUBLIC_WC_API_BASE_URL.replace('/wcfmmp/v1', '/wc/v3');
...
export default async function ProductDetailPage({ params }) {
  ...
  return (
    <section className="max-w-full md:max-w-5xl mx-auto py-0 md:py-6">
      <div className="px-4 py-4 md:px-0">
        <h1 className="text-2xl font-semibold mb-0 md:mb-6">Edit Product</h1>
      </div>
